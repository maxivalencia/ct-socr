 ...
 */
final class Version20190415053411 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD profession_id INT NOT NULL, ADD centre_id INT NOT NULL, ADD nom VARCHAR(255) NOT NULL, ADD prenom VARCHAR(255) NOT NULL, ADD date_inscription DATE NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP profession_id, DROP centre_id, DROP nom, DROP prenom, DROP date_inscription');
    }
}
