 ...
 */
final class Version20240508110906 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE photo CHANGE controle_id controle_id INT DEFAULT NULL, CHANGE file_name file_name VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE photo CHANGE controle_id controle_id INT DEFAULT NULL, CHANGE file_name file_name LONGBLOB NOT NULL');
