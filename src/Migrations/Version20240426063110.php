 ...
 */
final class Version20240426063110 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE photo (id INT AUTO_INCREMENT NOT NULL, controle_id INT DEFAULT NULL, nom_photo VARCHAR(255) NOT NULL, file_name VARCHAR(255) NOT NULL, INDEX IDX_14B78418758926A6 (controle_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE photo ADD CONSTRAINT FK_14B78418758926A6 FOREIGN KEY (controle_id) REFERENCES controles (id)');
